...
export default function Login() {
    ...
    return (
        <div className="container">
            <img src={GoogleLogo} className="mx-auto d-block m-4" style={{width:80}} alt="" />
            <div className="text-center pb-5">
                <GoogleLogin
                    clientId="449086482050-t6e9tflhou1r9b905s42pvjtbvac23hl.apps.googleusercontent.com"
                    render={renderProps => (
                        <button type="btn btn-primary" className="btn btn-outline-primary btn-lg" onClick={renderProps.onClick} disabled={renderProps.disabled}>
                            Login with Google
            ...
            <img src={GitHubSymbol} className="mx-auto d-block m-4" style={{width:80}} alt="" />
