...
//Without this class, non-root requests are not handled by the React Router//This class is necessary to forward requests to root so they can be handled by the React Router
